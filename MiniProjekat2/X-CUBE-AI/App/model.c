...
#define AI_MODEL_MODEL_SIGNATURE     "3b8ce54c1a2845a57ad45ed40af9fbe7"
...
#define AI_TOOLS_DATE_TIME   "Wed Dec 20 23:26:06 2023"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    92216, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_MODEL_IN_NUM, &input_0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_MODEL_OUT_NUM, &dense_3_output),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_model_activations_map, 1, params)) {
    ...
    input_0_output_array.data = AI_PTR(g_model_activations_map[0] + 0);
    input_0_output_array.data_start = AI_PTR(g_model_activations_map[0] + 0);
    
    conv2d_1_conv2d_output_array.data = AI_PTR(g_model_activations_map[0] + 1080);
    conv2d_1_conv2d_output_array.data_start = AI_PTR(g_model_activations_map[0] + 1080);
    
    conv2d_1_output_array.data = AI_PTR(g_model_activations_map[0] + 1080);
    conv2d_1_output_array.data_start = AI_PTR(g_model_activations_map[0] + 1080);
    
    max_pooling2d_1_output_array.data = AI_PTR(g_model_activations_map[0] + 1080);
    max_pooling2d_1_output_array.data_start = AI_PTR(g_model_activations_map[0] + 1080);
    
    dense_1_dense_output_array.data = AI_PTR(g_model_activations_map[0] + 0);
    dense_1_dense_output_array.data_start = AI_PTR(g_model_activations_map[0] + 0);
    
    dense_1_output_array.data = AI_PTR(g_model_activations_map[0] + 512);
    dense_1_output_array.data_start = AI_PTR(g_model_activations_map[0] + 512);
    
    dense_2_dense_output_array.data = AI_PTR(g_model_activations_map[0] + 0);
    dense_2_dense_output_array.data_start = AI_PTR(g_model_activations_map[0] + 0);
    
    dense_2_output_array.data = AI_PTR(g_model_activations_map[0] + 512);
    dense_2_output_array.data_start = AI_PTR(g_model_activations_map[0] + 512);
    
    dense_3_dense_output_array.data = AI_PTR(g_model_activations_map[0] + 0);
    dense_3_dense_output_array.data_start = AI_PTR(g_model_activations_map[0] + 0);
    
    dense_3_output_array.data = AI_PTR(g_model_activations_map[0] + 24);
    dense_3_output_array.data_start = AI_PTR(g_model_activations_map[0] + 24);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_model_weights_map, 1, params)) {
    ...
    conv2d_1_conv2d_bias_array.data = AI_PTR(g_model_weights_map[0] + 0);
    conv2d_1_conv2d_bias_array.data_start = AI_PTR(g_model_weights_map[0] + 0);
    
    dense_1_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_weights_array.data = AI_PTR(g_model_weights_map[0] + 576);
    dense_1_dense_weights_array.data_start = AI_PTR(g_model_weights_map[0] + 512);
    
    dense_1_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_bias_array.data = AI_PTR(g_model_weights_map[0] + 361024);
    dense_1_dense_bias_array.data_start = AI_PTR(g_model_weights_map[0] + 361024);
    
    dense_2_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_2_dense_weights_array.data = AI_PTR(g_model_weights_map[0] + 361600);
    dense_2_dense_weights_array.data_start = AI_PTR(g_model_weights_map[0] + 361536);
    
    dense_2_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_2_dense_bias_array.data = AI_PTR(g_model_weights_map[0] + 369792);
    dense_2_dense_bias_array.data_start = AI_PTR(g_model_weights_map[0] + 369792);
    
    dense_3_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_3_dense_weights_array.data = AI_PTR(g_model_weights_map[0] + 370304);
    dense_3_dense_weights_array.data_start = AI_PTR(g_model_weights_map[0] + 370304);
    
    dense_3_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_3_dense_bias_array.data = AI_PTR(g_model_weights_map[0] + 373376);
    dense_3_dense_bias_array.data_start = AI_PTR(g_model_weights_map[0] + 373376);
    
    conv2d_1_conv2d_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_1_conv2d_weights_array.data = AI_PTR(g_model_weights_map[0] + 373400);
    conv2d_1_conv2d_weights_array.data_start = AI_PTR(g_model_weights_map[0] + 373400);
