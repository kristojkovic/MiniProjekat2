...
#define AI_MODEL_IN_1_HEIGHT      (90)
#define AI_MODEL_IN_1_WIDTH       (3)
#define AI_MODEL_IN_1_CHANNEL     (1)
#define AI_MODEL_IN_1_SIZE        (90 * 3 * 1)
#define AI_MODEL_IN_1_SIZE_BYTES  (1080)
...
#define AI_MODEL_OUT_1_CHANNEL     (6)
#define AI_MODEL_OUT_1_SIZE        (6)
#define AI_MODEL_OUT_1_SIZE_BYTES  (24)

/******************************************************************************/
#define AI_MODEL_N_NODES (9)
